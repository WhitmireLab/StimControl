...
% vid.FramesAcquiredFcn = {@basic_saveImageData, fileName}; %enable TIFF saving
...
%     https://de.mathworks.com/help/matlab/import_export/exporting-to-images.html#br_c_iz-1
% https://de.mathworks.com/matlabcentral/answers/250229-how-to-save-images-into-a-tiff-stack
    %image each trial
...
%         nframes = vid.FramesAcquired;
    ...
    data = getdata(vid,vid.FramesAcquired);
    
    
%     data = cell(1,vid.FramesAcquired);
%     for frameN=1:vid.FramesAcquired
%         data{frameN} = getdata(vid,frameN);
%     end
    
    
    for ii = 1:vid.nTrials
            saveastiff(vid.Stack{ii},...
